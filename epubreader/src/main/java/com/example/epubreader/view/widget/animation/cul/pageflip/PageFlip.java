 ...
 */
package com.example.epubreader.view.widget.animation.cul.pageflip;
...
public class PageFlip {
    ...
    public boolean canAnimate(float touchX, float touchY) {
        return (mFlipState == PageFlipState.FORWARD_FLIP && !mPages[FIRST_PAGE].contains(mViewRect.toOpenGLX(touchX), mViewRect.toOpenGLY(touchY)));
    }
