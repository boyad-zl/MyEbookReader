...
import com.example.epubreader.view.widget.animation.CurlAnimationProvider;
...
import static com.example.epubreader.view.widget.BookReaderView.DrawHandler.MESSAGE_DRAW_CURRENT_PAGE;

/**
 * Created by Boyad on 2017/11/21.
 */

public class BookReaderView extends SurfaceView implements View.OnLongClickListener, BookReadListener, SurfaceHolder.Callback {
                    ...
                    if (animator.inProgress()) {
                        ...
                        try {
                            synchronized (mHolder) {
                                ...
                                canvas = mHolder.lockCanvas(canvasRect);
